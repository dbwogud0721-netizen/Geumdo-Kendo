...
function StartIcon() {
  return (
    <svg viewBox="0 0 44 44" fill="none" stroke="currentColor" strokeWidth="1.3" className="w-9 h-9 md:w-11 md:h-11">
    ...
    <section id="intro" className="bg-white border-b border-gray-100" style={{ padding: '40px 0' }}>
      <div className="mx-auto max-w-[1200px] px-5 md:px-10">
        ...
        <div className="block md:hidden">
          <div className="mb-7">
            <h2 className="text-[16px] font-bold text-navy-900 mb-2">검도장 소개</h2>
            <div className="w-6 h-0.5 bg-gold-400 mb-3" />
            ...
            {FEATURES.map((f, i) => {
              ...
              return (
                <div key={f.title} className="flex items-start gap-4">
                  <div className="text-navy-900 shrink-0 mt-0.5"><Icon /></div>
                  <div>
                    <h3 className="text-[13px] font-bold text-navy-900 mb-1">{f.title}</h3>
